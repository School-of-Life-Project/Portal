...
## Known Issues
- A Course Map containing zero Courses will cause the app to crash. This is a bug and will be fixed in the next release.
- Badly designed Course Maps will cause the app to crash. This is a bug and will be fixed in the next release.
