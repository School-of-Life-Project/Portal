...
Portal is designed to perform well on low-end hardware and does not require an internet connection to use. Portal can be run on Windows >= 7, macOS >= 10.15, and most Linux distributions.
